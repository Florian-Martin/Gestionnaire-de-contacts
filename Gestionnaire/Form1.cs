...
namespace Gestionnaire
{
    public partial class Form1 : Form
    {
        ...
        /**
         * Vidage des champs Nom / Prenom / Tel de la PictureBox
         */
        private void vidage()
        {
            txtNom.Text = "";
        ...
        * L'utilisateur peut changer son image de profil via recherche dans ses dossiers personnels.
        */
        ...
        private void lstContacts_DrawItem(object sender, DrawItemEventArgs e)
        {
            if (e.Index != -1)
            {
                ...
                foreach (var contact in lesContacts)
                {
                    ...
                    {
                        // Définit la couleur du texte selon type Particulier ou Professionnel du contact
                        if (contact is Particulier)
                        {
                        ...
                        // écrit la ligne en utilisant la couleur définie, bleu ou rouge
        ...
        */
        ...
        /**
         * Evènement: clic sur le bouton Reset
         * Vide le champ de recherche de contact via téléphone
         */
