...
namespace Gestionnaire
{
    public partial class Form1 : Form
    {
        ...
        {
            if (rdbParticulier.Checked || rdbPro.Checked)
            {
        ...
        private void btnModifier_Click(object sender, EventArgs e)
        {
            ...
            {
                // Stockage (via index) du contact à modifier
                int index = 0;
        ...
        */
        private void lstContacts_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {    
                ...
                Contact leContact = trouveContact(lstContacts.SelectedItem.ToString());
                // affichage de l'image
                pctPhoto.Image = leContact.getPhoto();
                */
            }
        }
        ...
        */
        private int trouveLigneParTel(string tel)
        {
            ...
            while (indice < lstContacts.Items.Count - 1
                && !extraireTel(lstContacts.Items[indice].ToString()).Equals(tel))
            {
                {
                    indice++;
                }
            ...
            if (extraireTel(lstContacts.Items[indice].ToString()).Equals(tel))
            {
                return indice;
            }
            else
